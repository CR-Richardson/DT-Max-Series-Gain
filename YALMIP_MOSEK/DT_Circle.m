...
%
% Purpose: 
% Compute the maximum series gain (alpha) when using the DT Circle criterion
% as defined by Theorem 12 and Remark 13.
%
% Parameters:
...
function [alpha_low,data,dec]=DT_Circle(syst,eps,alpha_up)
...
c3 = [A'*P*A - P,         alpha*A'*P*B + C'*V';
      alpha*B'*P*A + V*C, alpha*alpha*B'*P*B - 2*V] <= -epsilon*eye(n+m); % ND
